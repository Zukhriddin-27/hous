    ...
    <Container>
      ...
      <Content>
        ...
        <Details>
          <Details.Item>
            {' '}
            <Icons.Bed /> <div className='info'>Bed {bed || 0}</div>
          </Details.Item>
          <Details.Item>
            {' '}
            <Icons.Bath /> <div className='info'>Bath {bath || 0} </div>
          </Details.Item>
          <Details.Item>
            {' '}
            <Icons.Car /> <div className='info'>Garage {garage || 0}</div>
          </Details.Item>
          <Details.Item>
            {' '}
            <Icons.Ruler /> <div className='info'>Ruler {ruler || 0}</div>
          </Details.Item>
        </Details>
      </Content>
      <Devider />
